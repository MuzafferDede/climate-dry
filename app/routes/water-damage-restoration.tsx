		...
		<div>
			...
			<section className="bg-gray-100 full-w mb-6">
				<div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-center">
					...
					<div className="w-full lg:w-1/2">
						<img
							src="/images/layout/water-damage-restoration/CD-water-damage-banner.webp"
							alt="Water Damage"
			...
			<section className="py-10 mb-6">
				<SectionHeaderMulti
					...
					category_tag="p"
					title="Categories of water damage"
					title_tag="h2"
			...
			<div className="max-w-lg  mx-auto  mb-6">
				<SectionHeaderMulti
					...
					category_tag="p"
					title="Flood/Escape of Water Mitigation Packages"
					title_tag="h2"
					description=""
				/>
			</div>
			<ProductSection
				...
				alt="Flood Water Mitigation Packages Small"
				reverse
			/>
			...
			<ProductSection
				...
				image="/images/layout/water-damage-restoration/3-CD-Flood-Water-Mitigation-Packages-Large.webp"
				alt="Flood Water Mitigation Packages Large"
				reverse
			/>
			...
			<div className="max-w-lg m-10 mx-auto">
				<SectionHeaderMulti
					category=""
					category_tag="p"
					title="Professional Restorers - Insulation Drying Kits"
					title_tag="h2"
					description=""
				/>
			</div>
			...
			<ProductSection
				...
				image="/images/layout/water-damage-restoration/4-CD-Professional-Restorers-insulation-Drying-Kits-Starte-Kit.webp"
				alt="Professional Restorers insulation Drying Kits Starter Kit"
			/>
			...
			<ProductSection
				...
				image="/images/layout/water-damage-restoration/5-CD-Professional-Restorers-insulation-Drying-Kits-Basic-Kit.webp"
				alt="Professional Restorers insulation Drying Kits Basic Kit"
				reverse
			/>
			...
			<ProductSection
				...
				image="/images/layout/water-damage-restoration/6-CD-Professional-Restorers-insulation-Drying-Kits-Advanced-Kit.webp"
