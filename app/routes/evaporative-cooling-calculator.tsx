...
export default function DryingCalculatorPage() {
	...
	const [result, setResult] = useState<null | { volume: number; mh: number }>(null);

	function calculateRoomVolume(): number {
		const manual = parseFloat(cubicCapacity);
	...
	return (
                ...
                {result && (
                    ...
                    <div className="mx-auto mt-8 max-w-5xl space-y-10 rounded-lg bg-white p-8">
                        ...
                        className="text-xxs text-center">
                            Please be aware, evaporative cooling calculations are approximations only.. The effectiveness of the unit also depends on heat retention properties of the space, location/placement of the unit, insulation type, window direction or sunlight infiltration. Please refer to the relevant manual and/or contact the sales team with any specific requirements around suitability.
                        </p>
                    </div>
			</div>
		...
		<div className="mx-auto mt-8 max-w-5xl space-y-10 rounded-lg bg-white p-8">
        <h2 className="text-center font-bold text-2xl text-navy-darkest">Delta Temperature Chart</h2>

        <p>The delta temperature of the air coming from an evaporative cooler can vary depending on a number of factors including relative humidity within the space, water temperature, airflow setting and more</p>

            <table  className="table-auto border-collapse w-full table-bordered" id="evaporative-cooling-table">
                <colgroup width="80"></colgroup>
                <colgroup width="107"></colgroup>
                <colgroup span="17" width="80"></colgroup>
                <tbody><tr>
                    <td className="border px-4 py-2" height="19" colspan="19">Evaporative Cooler Output Temperature Look-Up</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2" colspan="3" rowspan="3" height="58">Celcius</td>
                    <td className="border px-4 py-2" colspan="16">Humidity%</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td className="border px-4 py-2" colspan="16">Example: 36°C and humidity 35% results in an output of 26°C</td>
                </tr>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19"><br /></td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">A</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">I</td>
                    <td className="border px-4 py-2">25</td>
                    <td className="border px-4 py-2"><br /></td>
                    <td className="border px-4 py-2">12</td>
                    <td className="border px-4 py-2">13</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">R</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">T</td>
                    <td className="border px-4 py-2">30</td>
                    <td className="border px-4 py-2"><br /></td>
                    <td className="border px-4 py-2">15</td>
                    <td className="border px-4 py-2">16</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">E</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">M</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">P</td>
                ...
                <tr className="air-temp">
                    <td className="border px-4 py-2" height="19">U</td>
                    <td className="border px-4 py-2">40</td>
                    <td className="border px-4 py-2"><br /></td>
                    <td className="border px-4 py-2">20</td>
                    <td className="border px-4 py-2">22</td>
