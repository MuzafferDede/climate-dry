...
export const CartSummary: React.FC<CartSummaryProps> = ({ cart }) => {
	...
	return (
		<div className="rounded-xl bg-gray-lightest p-6 shadow-sm">
			<h2 className="mb-6 font-bold text-navy-darkest text-xl">Cart Summary</h2>
				...
				<div className="rounded-lg border border-gray-lightest bg-white p-4">
					<div className="space-y-2">
						...
						{(cart?.totals.discount_amount ?? 0) > 0 && (
							<div className="flex items-center justify-between text-sm">
								<span className="font-semibold text-red">Discount</span>
