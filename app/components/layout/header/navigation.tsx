									...
									{({ open }) => (
										<>
											...
											{hasChildren && (
												<PopoverPanel
													as="div"
													className="fade-in slide-in-from-top-15 absolute top-full left-0 z-20 w-max animate-in pt-3"
													anchor="bottom start"
												>
													<div className="grid gap-2 rounded-b-lg bg-gray-200 p-3 shadow-lg">
														{item.banner && (
															<img
																src={item.banner}
														...
														<ul className="grid grid-cols-[1fr_auto] gap-3">
															{item.children?.map((child) => (
																...
																>
																	...
																	{child.children && (
																		<ul className="grid w-full grid-flow-col grid-rows-8 items-baseline gap-x-4 gap-y-1 rounded-lg border border-gray-200 bg-white p-2 font-semibold text-sm shadow">
